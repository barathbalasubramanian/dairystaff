...
const Feed = () => {
  ...
  return (
    <div className="App">
      ...
      <div className="flex items-center mt-4 py-10">
        <button
      ...
      <div className="flex w-[80%] justify-between max-lg:flex-col max-lg:gap-10 py-10">
        <div className="w-[45%] max-lg:w-[80%] m-auto">
            ...
            <div className="flex items-center justify-between bg-white p-4 rounded-lg shadow-md mb-4">
              ...
              <div className="flex items-center">
                <button 
                  ...
                  className="bg-gray-300 text-gray-700 w-8 h-8 flex items-center justify-center rounded-l hover:bg-gray-400 transition-colors">
                  -
                </button>
                ...
                <button 
                  ...
                  className="bg-gray-300 text-gray-700 w-8 h-8 flex items-center justify-center rounded-r hover:bg-gray-400 transition-colors">
                  +
                </button>
              </div>
            </div>
        ...
        <div className="w-[45%] m-auto max-lg:w-[80%] rounded-md bg-[#e0f7fa] p-4 py-10 flex items-center flex-col shadow-sm justify-between">
          ...
          <div className="space-y-2 py-6 w-[90%]"> 
            {cart && cart.map((item) => (
              <div className="min-w-full flex items-center justify-between bg-white p-4 rounded-lg shadow-md" key={item.id}>
                ...
                <div className="pl-2" onClick={() => updateQuantity(item, -item.quantity)} >
